...
Load details: `Read("${CLAUDE_SKILL_DIR}/references/configure-wizard.md")` for the full 5-step interactive configuration flow (branch strategy, commit scope, localhost browser, perf telemetry, log verbosity) and env var reference.
...
OrchestKit Readiness Score: 7.2 / 10  (stable channel, v7.0.0)
  ...
  Hook Protection ████████░░  8/10  83 hooks active
