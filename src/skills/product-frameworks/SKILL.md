...
Structured JSON output formats for consistent deliverables. See `references/output-templates.md` for PRD, business case, metrics framework, prioritization report, and research report templates.
