...
12. **MCP Status** - Active vs disabled vs misconfigured, API key presence for paid MCPs. CC 2.1.110: also warns when same MCP server defined in multiple config scopes with different endpoints
