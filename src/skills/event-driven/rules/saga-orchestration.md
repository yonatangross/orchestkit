...
impact: HIGH
impactDescription: "Saga orchestration manages distributed transactions — missing compensation steps leave systems in inconsistent states"
tags: saga, orchestration, distributed-transactions, compensation, microservices
---
...
# ALWAYS persist saga state to durable storage
```
