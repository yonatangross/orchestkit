...
| Rollback and data-integrity test harnesses | `references/migration-testing.md` |
...
| `lock_timeout`, `statement_timeout`, advisory locks during migration | https://www.postgresql.org/docs/current/runtime-config-client.html and `rules/versioning-drift.md` |
...
|----------|-------------|
| `references/ork-delta.md` | Our corrections and house conventions. Read this first |
| `references/migration-testing.md` | Upgrade/downgrade cycle and data-integrity test harnesses |
| `references/postgres-vs-mongodb.md` | Head-to-head comparison behind the PostgreSQL-first default |
| `references/db-migration-paths.md` | Cross-engine migration risk matrix |
| `references/cost-comparison.md` | Managed database cost analysis |
| `references/storage-and-cms.md` | Object storage and CMS selection |
