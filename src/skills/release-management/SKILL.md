...
Load Read("references/release-workflows.md") for step-by-step standard and hotfix release workflows.
...
Load Read("references/changelog-generation.md") for changelog template examples and Keep-a-Changelog format.
...
Load Read("references/release-automation.md") for CI workflow, bump script, and release checklist.
