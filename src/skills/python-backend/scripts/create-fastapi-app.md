...
# ============================================================================
# Middleware (RequestIDMiddleware, TimingMiddleware, LoggingMiddleware)
# See references/fastapi-app-boilerplate.md for full implementations
# ============================================================================

# Import: from starlette.middleware.base import BaseHTTPMiddleware
# RequestIDMiddleware - adds X-Request-ID header (uuid4)
# TimingMiddleware - adds X-Response-Time header
# LoggingMiddleware - structured request logging with structlog
...
# ============================================================================
# Exception Handlers (RFC 9457 problem+json format)
# See references/fastapi-app-boilerplate.md for full implementations
# ============================================================================

# HTTPException handler - returns application/problem+json with trace_id
# Generic Exception handler - logs via structlog, returns 500 with trace_id
