...
name: ci-debug
license: MIT
compatibility: "Claude Code 2.1.206+ — uses `gh` CLI for GitHub Actions log inspection. Works in interactive sessions and headless `claude -p --bare` invocations (e.g. /ork:ci-sentinel)."
