...
const scored = await pipeline(
  SKILLS,
  (s) => agent(
    `Read src/skills/${s}/SKILL.md (repo-relative to your cwd) and score this ONE skill's fitness for current Claude Code (mid-2026, floor 2.1.220, current model Opus 4.8).
