...
|---|---|
| `database-engineer` | Event store tables, read-model projection schemas, or partition/index DDL need a dedicated migration pass beyond your event schema design |
