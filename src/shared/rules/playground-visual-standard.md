...
- `user-story-player.template.html` — canonical gold standard and generalized player scaffold
  (device mockup + transport + flow, RTL-ready). Study the bar.
...
- **warm-glass** ("warm intelligence") — amber/emerald accents, frosted surfaces, rounded. Default
  for consumer/family/approachable products. Matches the user-story player exemplar.
