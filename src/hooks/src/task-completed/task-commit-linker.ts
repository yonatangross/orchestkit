 ...
 */
export function taskCommitLinker(input: HookInput, ctx?: HookContext): HookResult {
  ...
  (ctx?.log ?? logHook)(HOOK_NAME, `Task #${taskId} completed with ${dirtyCount} dirty files`);
