...
describe('Cross-Bundle Consistency', () => {
  ...
  test('total hook count matches expected', () => {
    ...
    // 226 -> 227: M119 #1795 — ask-fallback-injector (M104 PR-A: moved from
    ...
    expect(totalHooks).toBe(191); // 197 - 6: #3835 wave 1 (4 agent safety checks, compound-command-validator, agent-browser-safety)
  });
});
