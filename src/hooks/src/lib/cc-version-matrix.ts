...
export const MIN_CC_VERSION = '2.1.148';
...
export const CC_FEATURE_MATRIX: readonly CCFeatureEntry[] = [
  ...
  // 2.1.133 (2026-05-10) — parallel-session refresh-token race, Remote Control stop/interrupt, MCP OAuth proxy/mTLS, mapped network drives
  { feature: 'parallel_session_refresh_token_race_fix', minVersion: '2.1.133', description: 'Parallel sessions no longer 401 after shared-credential refresh-token race' },
  ...
  { feature: 'agent_view_command',                      minVersion: '2.1.139', description: 'claude agents (Research Preview) — unified list of every CC session: running, blocked on you, or done. Cross-session observability for parallel agent workflows. Use directly; OrchestKit documents the three parallel primitives at docs/parallel-primitives.md.' },
