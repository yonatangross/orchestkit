...
// Created: 2026-03-02
// DEPRECATED: Replaced by native type:http hooks in hooks.json (CC 2.1.63+).
// This file is kept as a fallback reference. The hooks.json entries for
// WorktreeCreate and WorktreeRemove now post directly to
// https://hq.yonatangross.com/api/hooks/cc-event without spawning a Node
// process. Remove this file once native http hooks are confirmed stable.
