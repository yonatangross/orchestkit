...
// Created: 2026-02-28
// DEPRECATED: Replaced by native type:http hook in hooks.json (CC 2.1.63+).
// This file is kept as a fallback reference. The hooks.json entry for
// SessionEnd now posts directly to https://hq.yonatangross.com/api/hooks/cc-event
// without spawning a Node process. Remove this file once native http hooks
// are confirmed stable in production.

/**
 * Session End Reporter — Posts token usage + session metrics to HQ API
 *
