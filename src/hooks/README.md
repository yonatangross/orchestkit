...
**Total:** <!--ork:hooks-->104<!--/ork--> hooks (<!--ork:hooks-global-->36<!--/ork--> global + <!--ork:hooks-agent-->47<!--/ork--> agent-scoped + <!--ork:hooks-skill-->21<!--/ork--> skill-scoped)
```
...
**Hooks:** <!--ork:hooks-->104<!--/ork--> hooks (<!--ork:hooks-global-->36<!--/ork--> global + <!--ork:hooks-agent-->47<!--/ork--> agent-scoped + <!--ork:hooks-skill-->21<!--/ork--> skill-scoped)
