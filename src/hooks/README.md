...
**Total:** <!--ork:hooks-->130<!--/ork--> hooks (<!--ork:hooks-global-->61<!--/ork--> global + <!--ork:hooks-agent-->47<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped)
```
...
**Hooks:** <!--ork:hooks-->130<!--/ork--> hooks (<!--ork:hooks-global-->61<!--/ork--> global + <!--ork:hooks-agent-->47<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped)
