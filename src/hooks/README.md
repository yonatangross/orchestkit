...
**Total:** <!--ork:hooks-->154<!--/ork--> hooks (<!--ork:hooks-global-->85<!--/ork--> global + <!--ork:hooks-agent-->47<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped)
```
...
**Hooks:** <!--ork:hooks-->154<!--/ork--> hooks (<!--ork:hooks-global-->85<!--/ork--> global + <!--ork:hooks-agent-->47<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped)
