...
**Total:** <!--ork:hooks-->101<!--/ork--> hooks (<!--ork:hooks-global-->32<!--/ork--> global + <!--ork:hooks-agent-->45<!--/ork--> agent-scoped + <!--ork:hooks-skill-->24<!--/ork--> skill-scoped)
```
...
**Hooks:** <!--ork:hooks-->101<!--/ork--> hooks (<!--ork:hooks-global-->32<!--/ork--> global + <!--ork:hooks-agent-->45<!--/ork--> agent-scoped + <!--ork:hooks-skill-->24<!--/ork--> skill-scoped)
