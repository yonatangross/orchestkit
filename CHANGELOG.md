...
## [8.28.0](https://github.com/yonatangross/orchestkit/compare/v8.27.2...v8.28.0) (2026-06-08)
...
## [8.25.1](https://github.com/yonatangross/orchestkit/compare/v8.25.0...v8.25.1) (2026-06-07)
...
## [8.16.2](https://github.com/yonatangross/orchestkit/compare/v8.16.1...v8.16.2) (2026-06-03)
...
## [8.16.1](https://github.com/yonatangross/orchestkit/compare/v8.16.0...v8.16.1) (2026-06-03)
...
## [8.16.0](https://github.com/yonatangross/orchestkit/compare/v8.15.0...v8.16.0) (2026-06-03)
...
## [8.6.4](https://github.com/yonatangross/orchestkit/compare/v8.6.3...v8.6.4) (2026-05-24)
...
## [7.89.0](https://github.com/yonatangross/orchestkit/compare/v7.88.1...v7.89.0) (2026-05-13)
...
## [7.85.0](https://github.com/yonatangross/orchestkit/compare/v7.84.0...v7.85.0) (2026-05-07)
...
## [7.84.0](https://github.com/yonatangross/orchestkit/compare/v7.83.2...v7.84.0) (2026-05-07)
...
## [7.71.2](https://github.com/yonatangross/orchestkit/compare/v7.71.1...v7.71.2) (2026-04-26)
...
## [7.65.0](https://github.com/yonatangross/orchestkit/compare/v7.64.0...v7.65.0) (2026-04-22)
...
- Issue #1444 (hook backfill for StopFailure/PostCompact/WorktreeCreate/WorktreeRemove): **no action** — all 4 hooks already registered in `hooks.json`. Brainstorm misread the matrix.
- Issue #1449 (CwdChanged/FileChanged hooks): **no action** — both already registered.
- Issue #1453 (Setup/SubagentStart/InstructionsLoaded/TaskCreated hooks): **no action** — all 4 already registered.
- Issue #1445 (deprecated-ref sweep): **no action** — all apparent hits are either legitimate historical documentation or false positives (`node/tag` in LangGraph, GitHub release URLs).
...
<!-- Ghost entry removed: no v7.62.0 tag was ever cut. Content shipped as v7.63.0
     via release-please (PRs #1434, #1437). See v7.63.0 section above. Issue #1440. -->
...
## [7.54.0](https://github.com/yonatangross/orchestkit/compare/v7.53.0...v7.54.0) (2026-04-19)

**Bet A polish — milestone #113 close-out.** Two follow-ups from the first real `/ork:design-ship` dogfood (#1399):
...
The #1399 dogfood proved the Bet A pipeline works end-to-end on a real handoff URL, but exposed two regressions: (1) a same-length nested-fence bug in the original `design-import.mdx` that broke every PR's docs build, and (2) the agent's expected schema diverged from reality. This release closes both gaps so the next `/ork:design-ship` invocation runs against a guard-protected pipeline with an accurate agent spec.



**Claude Design Integration — Bet A (Closed-Loop Pipeline)** — Milestone #113 complete. First-class integration with [claude.ai/design](https://claude.ai/design): handoff bundle URL → reviewable GitHub PR in one command.
...
- Claude Design has no public API yet — bundles are one-shot exports. Iteration means re-exporting from claude.ai/design and re-running `/ork:design-ship`. The programmatic drift-sync loop is **Bet B** (future milestone).
- Bundle schema is provisional — the orchestrator agent adapts to deviations and surfaces unknown fields rather than failing silently.
- No auto-merge — skills open PRs; humans review and merge.
...
## [7.49.0](https://github.com/yonatangross/orchestkit/compare/v7.48.0...v7.49.0) (2026-04-16)
...
## [7.46.0](https://github.com/yonatangross/orchestkit/compare/v7.45.1...v7.46.0) (2026-04-15)
...
## [7.43.0](https://github.com/yonatangross/orchestkit/compare/v7.42.1...v7.43.0) (2026-04-14)
...
## [7.42.1](https://github.com/yonatangross/orchestkit/compare/v7.42.0...v7.42.1) (2026-04-14)
...
## [7.41.1](https://github.com/yonatangross/orchestkit/compare/v7.41.0...v7.41.1) (2026-04-13)
...
* **hooks:** break auto-lint revert loop with hash-guard git-add after format ([#1279](https://github.com/yonatangross/orchestkit/issues/1279))
* **hooks:** fix extractRationale always returning undefined (g flag + .match() drops capture groups)
* **security:** resolve 4 code scanning alerts — stack trace exposure + pinned deps annotation


## [7.41.0](https://github.com/yonatangross/orchestkit/compare/v7.40.0...v7.41.0) (2026-04-12)
...
## [7.39.0](https://github.com/yonatangross/orchestkit/compare/v7.38.0...v7.39.0) (2026-04-11)
...
## [7.31.0](https://github.com/yonatangross/orchestkit/compare/v7.30.1...v7.31.0) (2026-04-08)
