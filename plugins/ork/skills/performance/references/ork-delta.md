...
Upstream: https://developer.chrome.com/docs/lighthouse/ and https://developer.chrome.com/docs/devtools/performance/ (frontend side); skill supabase-postgres-best-practices (database side)
