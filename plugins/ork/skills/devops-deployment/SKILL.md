...
### CI/CD Pipelines
**Load: `Read("${CLAUDE_PLUGIN_ROOT}/skills/devops-deployment/references/ci-cd-pipelines.md")`**
...
### Kubernetes Basics
**Load: `Read("${CLAUDE_PLUGIN_ROOT}/skills/devops-deployment/references/kubernetes-basics.md")`**
...
**Load: `Read("${CLAUDE_PLUGIN_ROOT}/skills/devops-deployment/references/environment-management.md")`**
...
### Observability
**Load: `Read("${CLAUDE_PLUGIN_ROOT}/skills/devops-deployment/references/observability.md")`**
