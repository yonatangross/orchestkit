...
export function CacheIndicator({ cacheLayer, costSaved }: CacheIndicatorProps) {
  ...
  const labels = {
    L1: { text: 'Exact Match', color: 'green' },
    L2: { text: 'Semantic Match', color: 'blue' },
    L3: { text: 'Prompt Cached', color: 'purple' },
  };
...
```
1,000 analyses/day x $0.864 = $864/day = $315,360/year
```
...
```
Breakdown:
- L1 hits (10%): 100 x $0.00 = $0
- L2 hits (30%): 300 x $0.00 = $0
- L3 hits (50%): 500 x $0.0324 = $16.20
- L4 calls (10%): 100 x $0.864 = $86.40
...
async def test_cache_warm_from_golden():
    ...
    assert count >= 415  # 98 analyses x ~8 agents
