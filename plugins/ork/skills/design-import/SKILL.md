...
name: design-import
license: MIT
compatibility: "Claude Code 2.1.183+. Requires: claude-design-orchestrator agent. Optional: stitch, 21st-dev-magic, storybook-mcp MCP servers (used transitively via design-to-code)."
