...
name: ci-sentinel
license: MIT
compatibility: "Claude Code 2.1.139+ (uses --permission-mode + --no-session-persistence for headless GHA runs; --bare was tried but doesn't honor ANTHROPIC_API_KEY in CC 2.1.143 — see SKILL body for the trade-off)."
