...
name: design-ship
license: MIT
compatibility: "Claude Code 2.1.78+. Requires: design-import skill, claude-design-orchestrator agent. Composes: cover, expect, create-pr."
...
- **No iteration loop**: if the PR review surfaces design changes, you currently re-export from Claude Design and re-run `/ork:design-ship`. (See Bet B for the future drift-sync workflow.)
