...
|------|------|-------------|
| Hexagonal Architecture | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/clean-hexagonal-ports-adapters.md` | Driving/driven ports, adapter implementations, layer structure |
| SOLID & Dependency Rule | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/clean-solid-dependency-rule.md` | Protocol-based interfaces, dependency inversion, FastAPI DI |
| DDD Tactical Patterns | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/clean-ddd-tactical-patterns.md` | Entities, value objects, aggregate roots, domain events |
...
| Rule | File | Key Pattern |
|------|------|-------------|
| Folder Structure & Nesting | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/structure-folder-conventions.md` | React/Next.js and FastAPI layouts, 4-level max nesting, barrel file rules |
...
| Rule | File | Key Pattern |
|------|------|-------------|
| Layer Separation | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/backend-layer-separation.md` | Router/service/repository boundaries, forbidden patterns, async rules |
| Dependency Injection | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/backend-dependency-injection.md` | Depends() chains, auth patterns, testing with DI overrides |
| File Naming & Exceptions | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/backend-naming-exceptions.md` | Naming conventions, domain exceptions, violation detection |
...
| Rule | File | Key Pattern |
|------|------|-------------|
| AAA Pattern & Isolation | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/testing-aaa-isolation.md` | Arrange-Act-Assert, test isolation, parameterized tests |
...
| Coverage & Location | `${CLAUDE_PLUGIN_ROOT}/skills/architecture-patterns/references/testing-coverage-location.md` | Coverage thresholds, fixture scopes, test file placement rules |
