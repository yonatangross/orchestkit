...
|performance-engineer:{performance-engineer.md}|performance,Core Web Vitals,LCP,INP,CLS,bundle size,Lighthouse,optimization,slow,latency,profiling,metrics,RUM,bundle,chunk,splitting,speed
