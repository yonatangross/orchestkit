...
|ci-automation:{SKILL.md,references/{cost-model.md,gh-action-patterns.md,headless-cli.md,loop-recipes.md,security.md}}|ci,cd,github-actions,automation,headless,claude-code-action
