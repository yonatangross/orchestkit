...
```bash
TARGET=$(bash "skills/review-pr/scripts/resolve-target.sh" $ARGUMENTS)  # one JSON object
```
...
See [Agent Prompts, Agent Tool Mode](skills/review-pr/rules/agent-prompts-task-tool.md) for the 6 parallel agent prompts.
