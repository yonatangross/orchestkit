...
|i18n-date-patterns:{SKILL.md,references/{formatting-utilities.md,ork-delta.md}}|i18n,internationalization,dayjs,dates,react-i18next,localization,rtl,useTranslation,useFormatting,ICU,Trans
