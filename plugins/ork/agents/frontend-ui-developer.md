...
agent-browser trace stop /tmp/component-trace.json
# Open trace in Chrome DevTools Performance panel for debugging
```
...
agent-browser find text "Save Changes"                 # Find by text
agent-browser find role button click --name "Delete"   # Find by role + accessible name
