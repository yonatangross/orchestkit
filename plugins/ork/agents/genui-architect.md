...
|
|json-render-catalog:{SKILL.md,references/{migration-from-genui.md,package-ecosystem.md,spec-format.md}}|json-render,genui,zod,catalog,shadcn,ai-ui,component-catalog,vercel
|multi-surface-render:{SKILL.md,references/{renderer-api.md,target-comparison.md}}|json-render,multi-surface,pdf,email,remotion,video,image,react,rendering
...
|mcp-visual-output:{SKILL.md,references/{component-recipes.md,mcp-integration.md}}|mcp,json-render,visual-output,dashboard,iframe,sandbox,interactive-ui,genui
```
