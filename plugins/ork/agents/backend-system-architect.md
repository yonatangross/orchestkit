...
|grpc-python:{SKILL.md,references/{error-handling.md,health-check-setup.md,interceptor-patterns.md,streaming-patterns.md}}|grpc,protobuf,microservices,rpc,streaming,python
|strawberry-graphql:{SKILL.md,references/{dataloader-patterns.md,federation-patterns.md,permission-classes.md,subscription-setup.md}}|graphql,strawberry,fastapi,dataloader,subscriptions,federation,python
...
|mcp-server-building:{SKILL.md,references/{auto-discovery.md,resource-patterns.md,testing-patterns.md,tool-definitions.md,transport-patterns.md}}|mcp,server,tools,integration
