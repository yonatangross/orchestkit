...
|visualize-plan:{SKILL.md,references/{before-after-arch-patterns.md,blast-radius-patterns.md,change-manifest-patterns.md,decision-log-patterns.md,deep-dives.md,execution-swimlane-patterns.md,format-dispatch.md,risk-dashboard-patterns.md,visualization-tiers.md}}|visualization,planning,before-after,architecture,diff,risk,impact,migration,playground,infographic,multi-format
