...
|visualize-plan:{SKILL.md,references/{before-after-arch-patterns.md,blast-radius-patterns.md,change-manifest-patterns.md,decision-log-patterns.md,decision-router.md,deep-dives.md,execution-swimlane-patterns.md,format-dispatch.md,risk-dashboard-patterns.md,visualization-tiers.md}}|visualization,planning,before-after,architecture,diff,risk,impact,migration,playground,infographic,multi-format
|security-patterns:{SKILL.md,references/{audit-logging.md,cc-permission-model.md,context-separation.md,langfuse-mask-callback.md,llm-guard-sanitization.md,logging-redaction.md,oauth-2.1-passkeys.md,output-guardrails.md,post-llm-attribution.md,pre-llm-filtering.md,presidio-integration.md,prompt-audit.md,request-context-pattern.md,tenant-isolation.md,vulnerability-demos.md,zod-v4-api.md}}|security,authentication,authorization,defense-in-depth,owasp,input-validation,llm-safety,pii-masking,jwt,oauth
