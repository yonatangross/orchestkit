...
|quality-gates:{SKILL.md,references/{ork-delta.md,unified-scoring-framework.md}}|quality,complexity,planning,escalation,blocking,best-practices,patterns,yagni,over-engineering
