...
```
[Skills for claude-design-orchestrator]
|root: ./skills
...
|design-import:{SKILL.md}|claude-design,handoff,design-import,design-to-code,bundle,scaffold,frontend
|design-ship:{SKILL.md}|claude-design,design-ship,end-to-end,pr,handoff,ship-it,frontend
