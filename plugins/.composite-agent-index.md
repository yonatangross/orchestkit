[OrchestKit Composite Agent Index]
|Generated from 2 plugins: ork, orkl
|Each plugin shares the same 36 agents with different skill sets.
|
|## ork (Full — 199 skills)
|root: ./agents
