...
allowed-tools: [Read, Grep, Glob, Bash, AskUserQuestion, mcp__memory__search_nodes, mcp__memory__read_graph, mcp__mem0__search_memories, mcp__mem0__get_memories]
---
