...
|plan-viz:{SKILL.md,references/{blast-radius-patterns.md,change-manifest-patterns.md,decision-log-patterns.md,deep-dives.md,execution-swimlane-patterns.md,risk-dashboard-patterns.md,visualization-tiers.md}}|visualization,planning,before-after,architecture,diff,risk,impact,migration
