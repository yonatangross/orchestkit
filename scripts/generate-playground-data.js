 ...
 * Outputs typed interfaces + exported constants to docs/site/lib/playground-data.ts
 */
function generateTypeScriptModule(data) {
  ...
  const lines = [
    ...
    '',
    `export const SKILLS: Record<string, SkillDetail> = ${JSON.stringify(skillsDetailed, null, 2)};`,
    '',
...
function generate() {
  ...
  // Ensure docs/site/lib/ directory exists
  ...
  console.log(`${GREEN}  TypeScript module: ${TS_OUTPUT_FILE}${NC}`);
