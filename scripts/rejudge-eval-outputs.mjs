...
//
// Usage:
//   node scripts/rejudge-eval-outputs.mjs <run.json> [hand-verdicts.json] [--judge claude-opus-5-5] [-j 4] [--case <prefix>]
//
...
const judge = args.includes("--judge") ? args[args.indexOf("--judge") + 1] : "claude-opus-5-5";
