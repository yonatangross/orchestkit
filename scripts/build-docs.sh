...
REFSKILLS_OUT="$PROJECT_ROOT/docs/site/content/docs/skills/reference-skills.mdx"
...
export PROJECT_ROOT SKILLS_SRC AGENTS_SRC HOOKS_JSON DOCS_OUT SKILLS_OUT AGENTS_OUT HOOKS_OUT CATEGORIES_OUT REFSKILLS_OUT
