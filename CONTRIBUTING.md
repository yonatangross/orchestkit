...
```
src/
├── skills/               # <!--ork:skills-->109<!--/ork--> skills (flat SKILL.md structure, CC 2.1.59+)
│   └── <skill-name>/
...
└── hooks/                # <!--ork:hooks-->194<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->109<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->194<!--/ork--> hooks)
```
