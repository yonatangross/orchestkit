...
└── hooks/                # <!--ork:hooks-->97<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->91<!--/ork--> skills, <!--ork:agents-->31<!--/ork--> agents, <!--ork:hooks-->97<!--/ork--> hooks)
```
