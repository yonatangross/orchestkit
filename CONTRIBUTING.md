...
```
src/
├── skills/               # <!--ork:skills-->112<!--/ork--> skills (flat SKILL.md structure, CC 2.1.59+)
│   └── <skill-name>/
...
└── hooks/                # <!--ork:hooks-->200<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->112<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->200<!--/ork--> hooks)
```
