...
```
src/
├── skills/               # <!--ork:skills-->105<!--/ork--> skills (flat SKILL.md structure, CC 2.1.59+)
│   └── <skill-name>/
...
└── hooks/                # <!--ork:hooks-->216<!--/ork--> TypeScript hooks in 11 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->105<!--/ork--> skills, <!--ork:agents-->36<!--/ork--> agents, <!--ork:hooks-->216<!--/ork--> hooks)
```
...
- The `plugins/` directory is **generated** but **is tracked in git**. Stage the
  regenerated output together with your `src/` change
