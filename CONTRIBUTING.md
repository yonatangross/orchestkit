...
└── hooks/                # <!--ork:hooks-->205<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->111<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->205<!--/ork--> hooks)
```
