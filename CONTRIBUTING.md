...
```
src/
├── skills/               # <!--ork:skills-->110<!--/ork--> skills (flat SKILL.md structure, CC 2.1.59+)
│   └── <skill-name>/
...
└── ork.json              # Single plugin (<!--ork:skills-->110<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->199<!--/ork--> hooks)
```
