...
```
src/
├── skills/               # <!--ork:skills-->113<!--/ork--> skills (flat SKILL.md structure, CC 2.1.59+)
│   └── <skill-name>/
...
└── ork.json              # Single plugin (<!--ork:skills-->113<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->212<!--/ork--> hooks)
```
