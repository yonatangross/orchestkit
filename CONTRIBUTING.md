...
└── hooks/                # <!--ork:hooks-->219<!--/ork--> TypeScript hooks in 11 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->105<!--/ork--> skills, <!--ork:agents-->36<!--/ork--> agents, <!--ork:hooks-->219<!--/ork--> hooks)
```
