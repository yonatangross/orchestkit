...
└── hooks/                # <!--ork:hooks-->105<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->93<!--/ork--> skills, <!--ork:agents-->33<!--/ork--> agents, <!--ork:hooks-->105<!--/ork--> hooks)
```
