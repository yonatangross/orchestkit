...
├── ork.json              # Main plugin (69 skills, 38 agents, 78 hooks)
├── orkl.json             # Alias for ork (backward compatibility)
└── ork-creative.json     # Alias for ork (backward compatibility)
```
...
├── ork/                  # Main plugin
├── orkl/                 # Alias (identical to ork)
└── ork-creative/         # Alias (identical to ork)
