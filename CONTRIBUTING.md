...
└── hooks/                # <!--ork:hooks-->174<!--/ork--> TypeScript hooks in 11 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->106<!--/ork--> skills, <!--ork:agents-->36<!--/ork--> agents, <!--ork:hooks-->174<!--/ork--> hooks)
```
