...
└── hooks/                # <!--ork:hooks-->191<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->108<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->191<!--/ork--> hooks)
```
