...
└── hooks/                # <!--ork:hooks-->214<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->114<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->214<!--/ork--> hooks)
```
