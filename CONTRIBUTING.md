...
```
src/
├── skills/               # <!--ork:skills-->111<!--/ork--> skills (flat SKILL.md structure, CC 2.1.59+)
│   └── <skill-name>/
...
└── hooks/                # <!--ork:hooks-->212<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->111<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->212<!--/ork--> hooks)
```
