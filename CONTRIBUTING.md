...
└── hooks/                # <!--ork:hooks-->104<!--/ork--> TypeScript hooks in 12 split bundles

manifests/                # Plugin definition
└── ork.json              # Single plugin (<!--ork:skills-->92<!--/ork--> skills, <!--ork:agents-->33<!--/ork--> agents, <!--ork:hooks-->104<!--/ork--> hooks)
```
