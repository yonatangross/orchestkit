...
import { BasePage } from '.claude/skills/webapp-testing/scripts/playwright-test-template';
...
import { Page, Locator } from '@playwright/test';
import { BasePage, WaitHelpers } from '.claude/skills/webapp-testing/scripts/playwright-test-template';
...
import { ApiMocker, CustomAssertions } from '.claude/skills/webapp-testing/scripts/playwright-test-template';
...
import { HomePage } from './pages/HomePage';
import { AnalysisProgressPage } from './pages/AnalysisProgressPage';
import { ApiMocker } from '.claude/skills/webapp-testing/scripts/playwright-test-template';
