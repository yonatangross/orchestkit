...
**OrchestKit** — Claude Code plugin: **68 skills**, **38 agents**, **54 hooks** (17 event types, 12 dispatchers, 9 native async).
...
├── agents/<name>.md          # 38 agents (CC 2.1.49 format)
...
- **Current**: 6.7.0 · **Claude Code**: >= 2.1.49 <!-- x-release-please-version -->
