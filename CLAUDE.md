...
**OrchestKit** — Claude Code plugin: **<!--ork:skills-->107<!--/ork--> skills**, **<!--ork:agents-->37<!--/ork--> agents**, **<!--ork:hooks-->187<!--/ork--> hooks** (<!--ork:hooks-global-->119<!--/ork--> global + <!--ork:hooks-agent-->46<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped).
...
Single plugin `ork`: <!--ork:skills-->107<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->187<!--/ork--> hooks (<!--ork:hooks-global-->119<!--/ork--> global + <!--ork:hooks-agent-->46<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped). <!--ork:invocable-->27<!--/ork--> user-invocable via `/ork:skillname`.
...
- **Current**: 7.84.0 · **Claude Code**: >= 2.1.132 <!-- x-release-please-version -->
