...
**OrchestKit** — Claude Code plugin: **69 skills**, **21 agents**, **96 hooks** (35 global + 54 agent-scoped + 7 skill-scoped).
...
├── agents/<name>.md          # 21 agents (CC 2.1.59 format)
...
**Single plugin**: `ork` — all 69 skills, 21 agents, 96 hooks.
