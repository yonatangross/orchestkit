...
**OrchestKit** — Claude Code plugin: **<!--ork:skills-->106<!--/ork--> skills**, **<!--ork:agents-->37<!--/ork--> agents**, **<!--ork:hooks-->182<!--/ork--> hooks** (<!--ork:hooks-global-->114<!--/ork--> global + <!--ork:hooks-agent-->46<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped).
...
Single plugin `ork`: <!--ork:skills-->106<!--/ork--> skills, <!--ork:agents-->37<!--/ork--> agents, <!--ork:hooks-->182<!--/ork--> hooks (<!--ork:hooks-global-->114<!--/ork--> global + <!--ork:hooks-agent-->46<!--/ork--> agent-scoped + <!--ork:hooks-skill-->22<!--/ork--> skill-scoped). <!--ork:invocable-->26<!--/ork--> user-invocable via `/ork:skillname`.

## Version

- **Current**: 7.70.0 · **Claude Code**: >= 2.1.118 <!-- x-release-please-version -->
