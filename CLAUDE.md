...
**OrchestKit** — Claude Code plugin: **67 skills**, **37 agents**, **54 hooks** (17 event types, 12 dispatchers, 9 native async).
...
- **Current**: 6.3.0 · **Claude Code**: >= 2.1.49 <!-- x-release-please-version -->
