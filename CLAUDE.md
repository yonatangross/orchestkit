...
**OrchestKit** — Claude Code plugin: **62 skills**, **37 agents**, **87 hooks** (63 global + 22 agent-scoped + 1 skill-scoped).
...
All plugins include 87 hooks. 24 skills are user-invocable via `/ork:skillname`.
