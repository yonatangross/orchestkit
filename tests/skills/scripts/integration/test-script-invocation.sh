...
TEST_SKILLS=(
    ...
    "testing-unit/scripts/create-test-fixture.md:User"
    "testing-integration/scripts/create-integration-test.md:auth-flow"
    "release-management/scripts/create-release.md:1.2.3"
    "testing-e2e/scripts/create-page-object.md:LoginPage"
    "testing-unit/scripts/create-test-case.md:calculateTotal"
    "testing-unit/scripts/create-msw-handler.md:/api/users"
