...
EXPECTED_SCRIPTS=(
    ...
    "testing-unit/scripts/create-test-fixture.md"
    "testing-integration/scripts/create-integration-test.md"
    "release-management/scripts/create-release.md"
    "testing-e2e/scripts/create-page-object.md"
    "testing-unit/scripts/create-test-case.md"
    "testing-unit/scripts/create-msw-handler.md"
