...
window.ORCHESTKIT_DATA = {
  ...
  plugins: [
    ...
    { name: "ork-workflows", description: "Implement, explore, verify, review-pr, commit, doctor, feedback", fullDescription: "Essential workflow commands that power the core development loop. Implements parallel subagent execution for feature building, deep codebase exploration, comprehensive verification, PR review with 6+ agents, smart commits, and skill evolution tracking.", category: "development", version: "5.7.2",
    ...
    { name: "ork-accessibility", description: "Accessibility patterns — wcag-compliance, a11y-testing, focus-management", fullDescription: "Accessibility patterns — wcag-compliance, a11y-testing, focus-management", category: "accessibility", version: "5.7.2",
      skills: ["wcag-compliance","a11y-testing","focus-management"],
      agents: ["accessibility-specialist"],
      commands: [],
      hooks: 0, color: "#14b8a6", required: false },

    { name: "ork-ai-observability", description: "AI Observability — langfuse-observability, cache-cost-tracking, evidence-verification", fullDescription: "AI Observability — langfuse-observability, cache-cost-tracking, evidence-verification", category: "ai", version: "5.7.2",
    ...
    { name: "ork-api", description: "API Design — FastAPI, GraphQL (Strawberry), REST patterns, streaming, versioning, rate-limiting, error-handling", fullDescription: "API Design — FastAPI, GraphQL (Strawberry), REST patterns, streaming, versioning, rate-limiting, error-handling", category: "backend", version: "5.7.2",
    ...
    { name: "ork-async", description: "Async & Tasks — asyncio-advanced, background-jobs, celery-advanced, distributed-locks, resilience-patterns", fullDescription: "Async & Tasks — asyncio-advanced, background-jobs, celery-advanced, distributed-locks, resilience-patterns", category: "backend", version: "5.7.2",
    ...
    { name: "ork-database", description: "Database patterns — sqlalchemy-2-async, alembic-migrations, database-schema-designer, database-versioning, zero-downtime-migration, connection-pooling", fullDescription: "Database patterns — sqlalchemy-2-async, alembic-migrations, database-schema-designer, database-versioning, zero-downtime-migration, connection-pooling", category: "backend", version: "5.7.2",
    ...
    { name: "ork-git", description: "Git/GitHub patterns — git-workflow, git-recovery-command, create-pr, fix-issue, issue-progress-tracking, stacked-prs", fullDescription: "Git/GitHub patterns — git-workflow, git-recovery-command, create-pr, fix-issue, issue-progress-tracking, stacked-prs", category: "development", version: "5.7.2",
    ...
    { name: "ork-langgraph", description: "LangGraph & Agent Orchestration — state, routing, parallel, checkpoints, functional, supervisor, human-in-loop, multi-agent, agent-loops, frameworks, temporal", fullDescription: "LangGraph & Agent Orchestration — state, routing, parallel, checkpoints, functional, supervisor, human-in-loop, multi-agent, agent-loops, frameworks, temporal", category: "ai", version: "5.7.2",
    ...
    { name: "ork-testing", description: "Testing — unit, integration, property-based, e2e, webapp, MSW, VCR, contract, test-data, standards, pytest", fullDescription: "Testing — unit, integration, property-based, e2e, webapp, MSW, VCR, contract, test-data, standards, pytest", category: "testing", version: "5.7.2",
    ...
    { name: "ork-video", description: "Video & Demo Production — demo-producer, remotion, manim, terminal-recording, storyboarding, narration, HeyGen avatars, audio mixing", fullDescription: "Video & Demo Production — demo-producer, remotion, manim, terminal-recording, storyboarding, narration, HeyGen avatars, audio mixing", category: "development", version: "5.7.2",
