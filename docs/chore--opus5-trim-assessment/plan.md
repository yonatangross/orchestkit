...
| `CLAUDE.md:11` → `shared/rules/anti-sycophancy.md` does not exist (real path `src/shared/rules/`); `visual-style.md` → `tests/perf/` does not exist (real: `tests/performance/`) | Fix both paths. | 0 B |
