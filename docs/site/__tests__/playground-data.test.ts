...
describe("playground-data", () => {
  ...
  describe("SKILLS", () => {
    ...
    it("has 60 skills", () => {
      expect(Object.keys(SKILLS).length).toBe(60);
    });
