	...
	return (
		...
		>
			<StructuredData
				nodes={[
					...
					breadcrumbNode([
						...
						{ name: "OrchestKit SDK packages", url: `${SITE.domain}/docs/sdk` },
					]),
				]}
			/>
			<h2>npm</h2>
			...
			<p>
				...
				<code>go get github.com/yonatangross/orchestkit/sdk</code>. Source:{" "}
				<a href="https://github.com/yonatangross/orchestkit/tree/main/sdk">
					github.com/yonatangross/orchestkit/tree/main/sdk
				</a>
