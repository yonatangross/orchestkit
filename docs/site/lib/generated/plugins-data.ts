...
export const PLUGINS: Plugin[] = [
  {
    "name": "orkl",
    "description": "Universal toolkit — 46 skills, 37 agents, 75 hooks. Language-agnostic, works for any stack.",
  ...
  {
    "name": "ork",
    "description": "Full specialized toolkit — 67 skills, 37 agents, 75 hooks. Adds Python, React, LLM/RAG patterns.",
