...
export const PLUGINS: Plugin[] = [
  {
    "name": "orkl",
    "description": "Universal toolkit — 52 skills, 36 agents, 90 hooks. Language-agnostic, works for any stack.",
  ...
  {
    "name": "ork",
    "description": "Full specialized toolkit — 88 skills, 36 agents, 90 hooks. Adds Python, React, LLM/RAG patterns.",
