...
export const PLUGINS: Plugin[] = [
  {
    "name": "orkl",
    "description": "Universal toolkit — 45 skills, 37 agents, 86 hooks. Language-agnostic, works for any stack.",
  ...
  {
    "name": "ork",
    "description": "Full specialized toolkit — 62 skills, 37 agents, 86 hooks. Adds Python, React, LLM/RAG patterns.",
