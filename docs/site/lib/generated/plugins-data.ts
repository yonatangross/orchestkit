...
export const PLUGINS: Plugin[] = [
  {
    "name": "orkl",
    "description": "Universal toolkit — 43 skills, 36 agents, 90 hooks. Language-agnostic, works for any stack.",
  ...
  {
    "name": "ork",
    "description": "Full specialized toolkit — 60 skills, 36 agents, 90 hooks. Adds Python, React, LLM/RAG patterns.",
