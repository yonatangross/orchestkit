...
description: "How OrchestKit's 81-hook system works: bundles, dispatchers, execution modes, and the stop pipeline."
---
...
<Tabs items={["Global (30)", "Agent-Scoped (44)", "Skill-Scoped (7)"]}>
<Tab value="Global (30)">
