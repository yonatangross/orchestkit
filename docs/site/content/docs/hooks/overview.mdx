---
title: "78 Hooks: What Fires When"
...
|----------|-------|-------------|
| **Global hooks** | 55 | Fire on every matching event regardless of agent |
...
| **Total** | **78** | Registered in `hooks.json`, compiled into 11 split bundles |

All 78 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
