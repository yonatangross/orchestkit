...
|----------|-------|-------------|
| **Global hooks** | 150 | Fire on every matching event regardless of agent |
...
| **Total** | **217** | Registered in `hooks.json`, compiled into 11 split bundles |

All 217 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
