...
|----------|-------|-------------|
| **Global hooks** | 30 | Fire on every matching event regardless of agent (10 matchers, 16 dispatchers) |
...
All 83 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
