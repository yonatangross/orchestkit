...
|----------|-------|-------------|
| **Global hooks** | 147 | Fire on every matching event regardless of agent |
...
| **Total** | **215** | Registered in `hooks.json`, compiled into 12 split bundles |

All 215 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
