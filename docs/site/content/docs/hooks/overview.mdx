...
|----------|-------|-------------|
| **Global hooks** | 148 | Fire on every matching event regardless of agent |
...
| **Total** | **216** | Registered in `hooks.json`, compiled into 12 split bundles |

All 216 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
