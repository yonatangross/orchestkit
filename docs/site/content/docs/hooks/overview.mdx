...
|----------|-------|-------------|
| **Global hooks** | 146 | Fire on every matching event regardless of agent |
...
| **Total** | **214** | Registered in `hooks.json`, compiled into 12 split bundles |

All 214 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
