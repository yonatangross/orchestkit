---
title: "86 Hooks: What Fires When"
...
|----------|-------|-------------|
| **Global hooks** | 63 | Fire on every matching event regardless of agent |
...
| **Total** | **86** | Registered in `hooks.json`, compiled into 11 split bundles |

All 86 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
