...
| **Total** | **218** | Registered in `hooks.json`, compiled into 12 split bundles |

All 218 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
