---
title: "186 Hooks: What Fires When"
...
|----------|-------|-------------|
| **Global hooks** | 118 | Fire on every matching event regardless of agent |
...
| **Total** | **186** | Registered in `hooks.json`, compiled into 12 split bundles |

All 186 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
