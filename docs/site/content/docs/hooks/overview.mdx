---
title: "183 Hooks: What Fires When"
...
|----------|-------|-------------|
| **Global hooks** | 115 | Fire on every matching event regardless of agent |
...
| **Total** | **183** | Registered in `hooks.json`, compiled into 12 split bundles |

All 183 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
