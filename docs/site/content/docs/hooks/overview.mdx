---
title: "81 Hooks: What Fires When"
...
| **Skill-scoped hooks** | 7 | Fire only during specific skill operations |
| **Total** | **81** | Registered in `hooks.json`, compiled into 12 split bundles |
