---
title: "188 Hooks: What Fires When"
...
|----------|-------|-------------|
| **Global hooks** | 120 | Fire on every matching event regardless of agent |
...
| **Total** | **188** | Registered in `hooks.json`, compiled into 12 split bundles |

All 188 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
