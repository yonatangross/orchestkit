...
| **Total** | **171** | Registered in `hooks.json`, compiled into 11 split bundles |

All 171 hooks are written in TypeScript, compiled via esbuild into ESM bundles, and executed by Node.js. Zero external dependencies in production.
