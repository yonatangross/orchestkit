...
OrchestKit is a single plugin: **ork** — 89 skills, 31 agents, 99 hooks. Install with `claude install orchestkit/ork`.
...
89 total: 16 command skills (user-invocable via `/ork:skillname`) and 73 reference skills (knowledge modules auto-injected by agents and hooks).
