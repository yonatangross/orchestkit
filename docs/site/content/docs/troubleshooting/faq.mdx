...
OrchestKit requires Claude Code 2.1.69 or later. Check your version:
...
OrchestKit is a single plugin: **ork** — 79 skills, 30 agents, 105 hooks. Install with `claude install orchestkit/ork`.
...
79 total: 18 command skills (user-invocable via `/ork:skillname`) and 61 reference skills (knowledge modules auto-injected by agents and hooks).
