...
OrchestKit is a single plugin: **ork** — 92 skills, 33 agents, 104 hooks. Install with `claude install orchestkit/ork`.
...
104 total: 36 global hooks, 47 agent-scoped hooks, and 21 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
