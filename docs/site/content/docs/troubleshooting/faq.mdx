...
OrchestKit requires Claude Code 2.1.84 or later. Check your version:
...
OrchestKit is a single plugin: **ork** — 103 skills, 36 agents, 115 hooks. Install with `claude install orchestkit/ork`.
...
115 total: 46 global hooks, 47 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
