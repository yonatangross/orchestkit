...
OrchestKit is a single plugin: **ork** — 106 skills, 37 agents, 182 hooks. Install with `claude install orchestkit/ork`.
...
182 total: 114 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
