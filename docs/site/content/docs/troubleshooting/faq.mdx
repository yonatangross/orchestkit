...
OrchestKit requires Claude Code 2.1.59 or later. Check your version:
...
71 total: 17 command skills (user-invocable via `/ork:skillname`) and 54 reference skills (knowledge modules auto-injected by agents and hooks).
