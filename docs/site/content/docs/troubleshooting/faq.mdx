...
OrchestKit is a single plugin: **ork** — 109 skills, 37 agents, 194 hooks. Install with `claude install orchestkit/ork`.
...
194 total: 126 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
