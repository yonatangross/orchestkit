...
OrchestKit is a single plugin: **ork** — 69 skills, 38 agents, 95 hooks. Install with `claude install orchestkit/ork`.
...
95 total: 34 global hooks (13 matchers, 16 dispatchers, 7 native async), 54 agent-scoped hooks, and 7 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
