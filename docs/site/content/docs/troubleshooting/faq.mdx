...
OrchestKit is a single plugin: **ork** — 109 skills, 37 agents, 195 hooks. Install with `claude install orchestkit/ork`.
...
195 total: 127 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
