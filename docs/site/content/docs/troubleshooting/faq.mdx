...
OrchestKit is a single plugin: **ork** — 112 skills, 37 agents, 200 hooks. Install with `claude install orchestkit/ork`.
...
200 total: 132 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
