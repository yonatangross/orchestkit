...
OrchestKit is a single plugin: **ork** — 107 skills, 37 agents, 188 hooks. Install with `claude install orchestkit/ork`.
...
188 total: 120 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
