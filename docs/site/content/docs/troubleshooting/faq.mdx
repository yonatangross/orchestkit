...
OrchestKit is a single plugin: **ork** — 71 skills, 30 agents, 81 hooks. Install with `claude install orchestkit/ork`.
...
81 total: 30 global hooks (10 matchers, 16 dispatchers), 44 agent-scoped hooks, and 7 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
