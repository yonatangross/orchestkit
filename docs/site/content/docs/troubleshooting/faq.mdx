...
OrchestKit is a single plugin: **ork** — 99 skills, 35 agents, 109 hooks. Install with `claude install orchestkit/ork`.
...
99 total: 20 command skills (user-invocable via `/ork:skillname`) and 79 reference skills (knowledge modules auto-injected by agents and hooks).
