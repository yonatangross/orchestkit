...
OrchestKit is a single plugin: **ork** — 111 skills, 37 agents, 212 hooks. Install with `claude install orchestkit/ork`.
...
212 total: 144 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
