...
OrchestKit is a single plugin: **ork** — 109 skills, 37 agents, 198 hooks. Install with `claude install orchestkit/ork`.
...
198 total: 130 global hooks, 46 agent-scoped hooks, and 22 skill-scoped hooks. They are compiled into 12 split bundles for faster loading.
