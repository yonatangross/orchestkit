---
title: "175 Skills That Power Agents"
...
Reference skills are the 175 skills with `user-invocable: false` in their frontmatter. You never invoke them directly. Instead, they are automatically injected into agent context through three paths:
...
- [24 Command Skills](/docs/skills/command-skills) -- The commands that orchestrate these reference skills.
