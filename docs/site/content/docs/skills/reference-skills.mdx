...
Reference skills are the 61 skills with `user-invocable: false` in their frontmatter. You never invoke them directly. Instead, they are automatically injected into agent context through three paths:
...
**Primary agents:** `monitoring-engineer`
...
| `persona-journey-mapping` | product-strategist | User persona creation and journey mapping |
| `user-research-methods` | product-strategist | User research methods: interviews, surveys, usability |
| `business-case-analysis` | product-strategist | ROI analysis, business case templates |
| `design-system-starter` | frontend-ui-developer | Design system bootstrapping and token systems |
| `motion-animation-patterns` | frontend-ui-developer | CSS and JS animation patterns |
...
| `prioritization-frameworks` | product-strategist | Prioritization methods and scoring models |
| `requirements-engineering` | product-strategist | Requirements gathering, user stories, acceptance criteria |
