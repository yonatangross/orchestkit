...
- [Reference Skills](/docs/skills/reference-skills): See how existing reference skills are structured.
- [Command Skills](/docs/skills/command-skills): If you want to create a command skill workflow.
