...
**14 skills** for unit, integration, e2e, performance, and llm testing patterns.
...
| [Emulate Seed](/docs/reference/skills/emulate-seed) | Reference | medium | Generate emulate seed configs for stateful API emulation. Wraps Vercel's emulate tool for GitHub (repos, PRs, issues,... |
