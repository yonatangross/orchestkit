...
**20 skills** for unit, integration, e2e, performance, and llm testing patterns.
...
| [Vercel Agent Browser](/docs/reference/skills/vercel-agent-browser) | Reference | medium | Browser automation CLI for AI agents. Navigate, snapshot, interact, extract data, test web apps. Covers headless Chro... |
| [Vercel Agent Browser Dogfood](/docs/reference/skills/vercel-agent-browser-dogfood) | Reference | low | Internal dogfooding patterns for agent-browser development and testing. |
| [Vercel Agent Browser Electron](/docs/reference/skills/vercel-agent-browser-electron) | Reference | low | Electron app automation with agent-browser. Test desktop apps via CDP. |
| [Vercel Emulate](/docs/reference/skills/vercel-emulate) | Reference | medium | Stateful API emulation for CI and no-network sandboxes. CLI + programmatic API for GitHub, Vercel, Google, Slack, App... |
| [Vercel Emulate Github](/docs/reference/skills/vercel-emulate-github) | Reference | low | GitHub API emulation: repos, PRs, issues, webhooks, GitHub Apps, installations. HMAC-SHA256 signed webhooks. |
