...
| [Glyph](/docs/reference/skills/glyph) | Command | low | One front door for visual answers. Infers the audience (operator or novice) and the surface (chat, ask, or page) from... |
