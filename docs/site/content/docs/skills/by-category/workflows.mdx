...
| [Paired Probe](/docs/reference/skills/paired-probe) | Command | low | Refuse a verdict a probe did not earn. Runs a check where the fault IS present and where it is NOT, and blocks the an... |
