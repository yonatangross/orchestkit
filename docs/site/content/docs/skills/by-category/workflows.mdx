...
| [Glyph](/docs/reference/skills/glyph) | Command | low | Render an answer as ASCII art plus semantic emojis inline, right now, with no setup questions: one render per reply, ... |
