...
| [Quickviz](/docs/reference/skills/quickviz) | Command | low | Render an answer as ASCII art plus semantic emojis inline, right now, with no setup questions. Use for a fast visual ... |
