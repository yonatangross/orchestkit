...
**32 skills** for user-invocable commands for common development workflows.
...
| [Ci Debug](/docs/reference/skills/ci-debug) | Command | medium | Diagnose a failing CI run against a 10-pattern playbook. Classifies the failure, cites the relevant memory entry, pro... |
