...
| [Auto](/docs/reference/skills/auto) | Command | medium | Intent-classified router — the front door to OrchestKit. Takes a plain-English goal, classifies it into one intent ca... |
