...
|-------|------|------------|-------------|
| [Audit Full](/docs/reference/skills/audit-full) | Reference | max | Single-pass codebase analysis leveraging Opus 4.6 1M context for comprehensive security scanning, architecture review... |
