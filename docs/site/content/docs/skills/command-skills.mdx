...
| `/ork:prd` | Product Requirements Documents with structured 8-section templates, user stories, acceptance criteria, and value proposition validation. | medium | `/ork:prd payments feature` |
