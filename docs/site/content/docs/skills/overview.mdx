...
OrchestKit ships 200 skills in two categories:

| Type | Count | Who triggers it | Frontmatter marker |
|------|-------|------------------|--------------------|
| **Command** | 24 | User types `/ork:skill-name` | `user-invocable: true` |
| **Reference** | 176 | Hooks or agent frontmatter inject it automatically | `user-invocable: false` |
...
- [23 Command Skills](/docs/skills/command-skills) -- The full list of `/ork:X` commands you can invoke directly.
- [176 Reference Skills](/docs/skills/reference-skills) -- The knowledge library that powers agents behind the scenes.
