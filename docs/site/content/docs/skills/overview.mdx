...
Of OrchestKit's 107 skills, **27 are user-invocable** command skills (you type `/ork:skill-name`). Of those, **22 are listed** in Claude's prompt context. **47 reference skills** are hidden from the listing entirely:
