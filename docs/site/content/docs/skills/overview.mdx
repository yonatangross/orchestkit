...
Of OrchestKit's 98 skills, **20 are user-invocable** command skills (you type `/ork:skill-name`). Of those, **20 are listed** in Claude's prompt context. The remaining 78 reference skills are hidden from the listing entirely:
