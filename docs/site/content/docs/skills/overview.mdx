...
OrchestKit ships 199 skills in two categories:

| Type | Count | Who triggers it | Frontmatter marker |
|------|-------|------------------|--------------------|
| **Command** | 24 | User types `/ork:skill-name` | `user-invocable: true` |
| **Reference** | 175 | Hooks or agent frontmatter inject it automatically | `user-invocable: false` |
...
- [24 Command Skills](/docs/skills/command-skills) -- The full list of `/ork:X` commands you can invoke directly.
- [175 Reference Skills](/docs/skills/reference-skills) -- The knowledge library that powers agents behind the scenes.
