...
**98 skills** covering: FastAPI, React, SQLAlchemy, RAG, LangGraph, OWASP, Terraform, and more.
...
**35 agents** covering: backend architecture, frontend UI, security auditing, test generation, debugging, deployment, and more.
...
**106 hooks** across 11 categories:
