...
**79 skills** covering: FastAPI, React, SQLAlchemy, RAG, LangGraph, OWASP, Terraform, and more.

### Two Types

| Type | Count | How It Works | Example |
|---|---|---|---|
| **Command** | 18 | You invoke directly: `/ork:commit` | `/ork:verify`, `/ork:implement` |
| **Reference** | 61 | Auto-injected into agents | `python-backend`, `security-patterns` |
...
**30 agents** covering: backend architecture, frontend UI, security auditing, test generation, debugging, deployment, and more.
...
|---|---|---|
| "review this PR" | `code-quality-reviewer` | code-review-playbook, testing-patterns |
...
**105 hooks** across 11 categories:
...
git push
  ...
  └─ posttool/workflow-analytics       → updates workflow analytics
```
