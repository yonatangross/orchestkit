...
**69 skills** covering: FastAPI, React, SQLAlchemy, RAG, LangGraph, OWASP, Terraform, and more.
...
| **Reference** | 52 | Auto-injected into agents | `python-backend`, `security-patterns` |
...
**38 agents** covering: backend architecture, frontend UI, security auditing, test generation, debugging, deployment, and more.
