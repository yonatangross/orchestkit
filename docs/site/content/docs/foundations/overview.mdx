...
OrchestKit ships as two plugins so you install only what you need:

| Plugin | Skills | Best For |
|--------|--------|----------|
| **orkl** | 109 | Any stack — workflows, memory, security, CI/CD |
| **ork** | 199 | orkl + Python, React, LLM/RAG, LangGraph, MCP |

Both include all 36 agents and 119 hooks. The difference is skill coverage.
