...
description: The complete AI development toolkit for Claude Code — 199 skills, 36 agents, 119 hooks working together.
---
...
|--------|--------|----------|
| **orkl** | 88 | Any stack — workflows, memory, security, CI/CD |
| **ork-creative** | 16 | Video production — demo recording, Remotion, storyboarding |
| **ork** | 199 | orkl + creative + Python, React, LLM/RAG, LangGraph, MCP |

All include 119 hooks. orkl and ork include all 36 agents. The difference is skill coverage.
