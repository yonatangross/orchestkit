...
description: The complete AI development toolkit for Claude Code — 200 skills, 36 agents, 122 hooks working together.
---
...
| **ork** | 200 | orkl + Python, React, LLM/RAG, LangGraph, MCP |

Both include all 36 agents and 122 hooks. The difference is skill coverage.
