...
description: The complete AI development toolkit for Claude Code — 69 skills, 38 agents, 78 hooks working together.
---
...
OrchestKit ships as a single plugin: **ork** — 69 skills, 38 agents, 78 hooks. The names `orkl` and `ork-creative` are preserved as backward-compatible install aliases that deliver the same plugin.
