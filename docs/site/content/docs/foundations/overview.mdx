...
description: The complete AI development toolkit for Claude Code — 200 skills, 36 agents, 98 hooks working together.
---
...
| **ork** | 200 | orkl + creative + Python, React, LLM/RAG, LangGraph, MCP |

All include 98 hooks. orkl and ork include all 36 agents. The difference is skill coverage.
