...
OrchestKit ships as two plugins. Both include **all 36 agents** and **122 hooks**. The difference is skill coverage.
...
Do you use Python, React, LLM/RAG, or LangGraph?
  ...
  │
  └─ NO ───▶ Install orkl (109 skills, universal toolkit)
```

## Comparison

| | **orkl** (Universal) | **ork** (Full) |
|---|---|---|
| **Skills** | 109 | 200 |
| **Agents** | 36 | 36 |
| **Hooks** | 122 | 122 |
...
**Start with `ork`** if you're building with FastAPI, React/Next.js, or LLM-powered applications. The extra 90 skills give agents significantly deeper knowledge in these domains.
