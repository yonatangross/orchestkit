...
OrchestKit ships as three plugins. Both orkl and ork include **all 36 agents** and **89 hooks**. The difference is skill coverage.
...
Do you use Python, React, LLM/RAG, or LangGraph?
  │
  ├─ YES ──▶ Install ork (62 skills, full specialized)
  │
  └─ NO ───▶ Install orkl (45 skills, universal toolkit)
