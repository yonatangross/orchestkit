...
OrchestKit ships as three plugins. Both orkl and ork include **all 36 agents** and **93 hooks**. The difference is skill coverage.
...
Do you use Python, React, LLM/RAG, or LangGraph?
  │
  ├─ YES ──▶ Install ork (200 skills, full specialized)
  │
