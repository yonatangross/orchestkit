...
<Accordion title="i18n: Formatting Anti-Patterns — CRITICAL">
...
<Accordion title="i18n: ICU Plural Rules — HIGH">
...
<Accordion title="i18n: Trans Component — HIGH">
...
<Accordion title="Formatting Utilities">
...
<Accordion title="Icu Messageformat">
...
<Accordion title="Trans Component">
...
<Accordion title="I18n Checklist">
...
<Accordion title="Component I18n Example">
