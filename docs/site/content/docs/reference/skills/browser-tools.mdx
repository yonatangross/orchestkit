...
<Accordion title="Browser: Auth Security — CRITICAL">
...
<Accordion title="Browser: Rate Limiting — HIGH">
...
<Accordion title="Browser: Scraping Ethics — CRITICAL">
...
<Accordion title="Browser: Snapshot Workflow — HIGH">
