...
<Accordion title="RSC: Cache Safety — CRITICAL">
...
<Accordion title="RSC: Client Boundaries — CRITICAL">
...
<Accordion title="RSC: Component Types — MEDIUM">
...
<Accordion title="RSC: Hydration — HIGH">
...
<Accordion title="RSC: Serialization — CRITICAL">
...
<Accordion title="Cache Components">
...
<Accordion title="Component Patterns">
...
<Accordion title="Nextjs 16 Upgrade">
...
<Accordion title="React 19 Patterns">
...
<Accordion title="Routing Patterns">
...
<Accordion title="Streaming Patterns">
...
<Accordion title="Tanstack Router Patterns">
...
<Accordion title="Rsc Implementation Checklist">
