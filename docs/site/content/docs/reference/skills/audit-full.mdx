...
<Accordion title="Architecture Review Guide">
...
<Accordion title="Dependency Audit Guide">
...
<Accordion title="Security Audit Guide">
...
<Accordion title="Token Estimation">
...
<Accordion title="Audit Completion">
