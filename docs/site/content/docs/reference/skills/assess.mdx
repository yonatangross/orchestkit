...
<Accordion title="Task Decomposition Strategies — HIGH">
...
<Accordion title="Complexity Scoring Frameworks — HIGH">
...
<Accordion title="Alternative Analysis">
...
<Accordion title="Improvement Prioritization">
...
<Accordion title="Scoring Rubric">
...
<Accordion title="Assessment Checklist">
