...
<Accordion title="Adaptive Retrieval — MEDIUM">
...
<Accordion title="Corrective RAG (CRAG) — HIGH">
...
<Accordion title="Knowledge Graph RAG (GraphRAG) — MEDIUM">
...
<Accordion title="Self-RAG — Document Grading — HIGH">
...
<Accordion title="Contextual Retrieval — Hybrid BM25+Vector — HIGH">
...
<Accordion title="Contextual Retrieval — Complete Pipeline — MEDIUM">
...
<Accordion title="Contextual Retrieval — Context Prepending — HIGH">
...
<Accordion title="Basic RAG Pattern — CRITICAL">
...
<Accordion title="Hybrid Search (Semantic + Keyword) — HIGH">
...
<Accordion title="Pipeline Composition — MEDIUM">
...
<Accordion title="Advanced Embedding Patterns — MEDIUM">
...
<Accordion title="Chunking Strategies — HIGH">
...
<Accordion title="Embedding Models & API — HIGH">
...
<Accordion title="HyDE Fallback Strategy — MEDIUM">
...
<Accordion title="HyDE Generation — HIGH">
...
<Accordion title="Per-Concept HyDE — MEDIUM">
...
<Accordion title="Multimodal Document Chunking — MEDIUM">
...
<Accordion title="Multimodal Embeddings — HIGH">
...
<Accordion title="Multimodal RAG Pipeline — MEDIUM">
...
<Accordion title="PGVector Hybrid Search (SQL) — HIGH">
...
<Accordion title="PGVector Index Strategies — HIGH">
...
<Accordion title="PGVector Metadata Filtering & Patterns — MEDIUM">
...
<Accordion title="PGVector Database Schema — HIGH">
...
<Accordion title="Query Decomposition + RRF Fusion — HIGH">
...
<Accordion title="Multi-Concept Query Detection — MEDIUM">
...
<Accordion title="Decomposition + HyDE Combo — MEDIUM">
...
<Accordion title="Combined Scoring & Reranking Service — MEDIUM">
...
<Accordion title="Cross-Encoder Reranking — HIGH">
...
<Accordion title="LLM Reranking — MEDIUM">
...
<Accordion title="Search Implementation Checklist">
