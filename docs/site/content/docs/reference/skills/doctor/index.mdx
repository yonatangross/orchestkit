...
- [References: Hook Validation](/docs/reference/skills/doctor/references/hook-validation): OrchestKit uses 149 global hook entries across 29 event types, compiled into 11 bundles.
