...
This reference is split across 19 pages so each stays under the 25K-token page budget. The rules and reference material that used to sit at the bottom of this page now live at:
