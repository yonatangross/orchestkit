...
- [References: Per-agent memory directory](/docs/reference/skills/doctor/references/agent-memory-dir): memory: in agent frontmatter writes .claude/agent-memory/NAME/MEMORY.md.
...
- [References: Skills Validation](/docs/reference/skills/doctor/references/skills-validation): OrchestKit includes 108 skills validated against frontmatter requirements and content standards.
- [References: Version Compatibility: Overview](/docs/reference/skills/doctor/references/version-compatibility/00-overview): OrchestKit requires Claude Code >= 2.1.277.
...
- [References: Version Compatibility: Feature Matrix (part 2)](/docs/reference/skills/doctor/references/version-compatibility/02-feature-matrix-part-2): Reading: on this account a user-tier hooks module (mods/lesson-cards via --plugin-dir) does NOT load with CLAUDECODEENABLEFUNCTIONHOOKS unset; the debug log...
