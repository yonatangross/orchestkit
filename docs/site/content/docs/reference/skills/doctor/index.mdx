...
This reference is split across 20 pages so each stays under the 25K-token page budget. The rules and reference material that used to sit at the bottom of this page now live at:

- [Rules](/docs/reference/skills/doctor/rules): 2 rules for the Doctor skill: Diagnostic Checks; MCP Status Checks
- [References: Per-agent memory directory](/docs/reference/skills/doctor/references/agent-memory-dir): memory: in agent frontmatter writes .claude/agent-memory/<agent>/MEMORY.md.
- [References: Agents Validation](/docs/reference/skills/doctor/references/agents-validation): OrchestKit includes 30 specialized agents validated against CC 2.1.69 frontmatter format.
- [References: Claude Code adapter: doctor](/docs/reference/skills/doctor/references/claude-code): Slash invoke: /ork:doctor
- [References: Health Check Output Examples](/docs/reference/skills/doctor/references/health-check-outputs): Reference output examples for each /ork:doctor check category.
- [References: Hook Validation](/docs/reference/skills/doctor/references/hook-validation): OrchestKit uses 152 global hook entries across 29 event types, compiled into 11 bundles.
- [References: MCP Pinning Check (Category 12 sub-check)](/docs/reference/skills/doctor/references/mcp-pinning-check): Warns when .mcp.json resolves HIGH-tier MCP servers to @latest.
- [References: Memory Health](/docs/reference/skills/doctor/references/memory-health): OrchestKit uses graph memory for knowledge persistence.
- [References: Permission Rules Analysis](/docs/reference/skills/doctor/references/permission-rules): CC 2.1.3 added detection for unreachable permission rules.
- [References: Remediation Guide](/docs/reference/skills/doctor/references/remediation-guide): Quick remediation steps for common /ork:doctor findings.
- [References: Doctor Report Format](/docs/reference/skills/doctor/references/report-format): Doctor Report Format for the Doctor skill.
- [References: Check 15: CC Bash-Sandbox Posture](/docs/reference/skills/doctor/references/sandbox-posture): OS sandbox is opt-in and Bash-only; doctor surfaces whether it's on and nudges it, but a session is healthy without it.
- [References: Schema Validation](/docs/reference/skills/doctor/references/schema-validation): OrchestKit uses JSON schemas to validate configuration files.
- [References: Check 16: Operator Settings Posture](/docs/reference/skills/doctor/references/settings-posture): a scope Claude Code actually reads.
- [References: Skills Validation](/docs/reference/skills/doctor/references/skills-validation): OrchestKit includes 107 skills validated against frontmatter requirements and content standards.
- [References: Version Compatibility: Overview](/docs/reference/skills/doctor/references/version-compatibility/00-overview): OrchestKit requires Claude Code >= 2.1.251.
- [References: Version Compatibility: Feature Matrix (part 1)](/docs/reference/skills/doctor/references/version-compatibility/01-feature-matrix-part-1): Part 2 of 4 of Version Compatibility for the Doctor skill.
- [References: Version Compatibility: Feature Matrix (part 2)](/docs/reference/skills/doctor/references/version-compatibility/02-feature-matrix-part-2): Part 3 of 4 of Version Compatibility for the Doctor skill.
- [References: Version Compatibility: Prompt Caching Recommendation](/docs/reference/skills/doctor/references/version-compatibility/03-prompt-caching-recommendation): For API-key, Bedrock, Vertex, or Foundry users running long OrchestKit sessions (brainstorm, implement, cover chains), enable 1-hour prompt caching
