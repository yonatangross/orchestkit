...
<Accordion title="Motion Library & View Transitions — HIGH">
...
<Accordion title="Scroll-Driven Animations — MEDIUM">
...
<Accordion title="PWA Offline & Installability — HIGH">
...
<Accordion title="PWA Service Worker & Workbox — HIGH">
...
<Accordion title="Container Queries">
...
<Accordion title="Fluid Typography">
