...
OrchestKit includes 37 specialized agents validated against CC 2.1.69 frontmatter format.
...
```
Installed Plugins: 1
- ork: 106 skills, 37 agents, 182 hooks
```
...
OrchestKit uses 114 global hook entries across 15 event types, compiled into 12 bundles. This reference explains how to validate and troubleshoot hooks.
