...
This reference is split across 4 pages so each stays under the 25K-token page budget. The rules and reference material that used to sit at the bottom of this page now live at:

- [Rules](/docs/reference/skills/verify/rules): 2 rules for the Verify skill: Evidence Collection Patterns; Scoring Rubric
- [References](/docs/reference/skills/verify/references): 17 references for the Verify skill: Alternative Comparison; Background task contract: never wait unconditionally; Claude Code; Grading Rubric; Orchestration Mode; Policy As Code; Progressive And Partial Results; Quality Model; Reachability Proof; Report Template; Streak Gate; Task Management; Verification Checklist; Verification Manifest; Verification Phases; Versions; Visual Capture
- [Checklists](/docs/reference/skills/verify/checklists): 1 checklists for the Verify skill: Verification Checklist
