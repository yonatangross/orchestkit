...
<Accordion title="Backend: Dependency Injection — HIGH">
...
<Accordion title="Backend: Layer Separation — HIGH">
...
<Accordion title="Backend: File Naming & Exceptions — HIGH">
...
<Accordion title="Clean: SOLID & Dependency Inversion — HIGH">
...
<Accordion title="Clean: Hexagonal Architecture — HIGH">
...
<Accordion title="Clean: DDD Tactical Patterns — HIGH">
...
<Accordion title="Right-Sizing Decision Guide — HIGH">
...
<Accordion title="Architecture Sizing Tiers — HIGH">
...
<Accordion title="Structure: Import Direction & Conventions — HIGH">
...
<Accordion title="Structure: Folder Organization — HIGH">
...
<Accordion title="Testing: AAA Pattern & Isolation — MEDIUM">
...
<Accordion title="Testing: Coverage & Fixtures — MEDIUM">
...
<Accordion title="Testing: Naming Conventions — MEDIUM">
...
<Accordion title="Backend Layers: Dependency Injection Patterns — HIGH">
...
<Accordion title="Backend Layers: Layer Separation Rules — HIGH">
...
<Accordion title="Backend Layers: File Naming & Domain Exceptions — HIGH">
...
<Accordion title="Clean Architecture: DDD Tactical Patterns — HIGH">
...
<Accordion title="Clean Architecture: Hexagonal Ports & Adapters — HIGH">
...
<Accordion title="Clean Architecture: SOLID Principles & Dependency Rule — HIGH">
...
<Accordion title="Hexagonal Architecture">
...
<Accordion title="Project Structure: Folder Conventions & Nesting — HIGH">
...
<Accordion title="Project Structure: Import Direction & Component Location — HIGH">
...
<Accordion title="Test Standards: AAA Pattern & Test Isolation — MEDIUM">
...
<Accordion title="Test Standards: Coverage Thresholds & File Location — MEDIUM">
...
<Accordion title="Test Standards: Naming Conventions — MEDIUM">
...
<Accordion title="Violation Examples">
...
<Accordion title="Solid Checklist">
...
<Accordion title="Fastapi Clean Architecture">
