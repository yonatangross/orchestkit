...
<Accordion title="CI/CD: Branch Protection — HIGH">
...
<Accordion title="CI/CD: Pipeline Caching — HIGH">
...
<Accordion title="DevOps: Database Migrations — CRITICAL">
...
<Accordion title="Docker: Layer Security — CRITICAL">
...
<Accordion title="Docker: Multi-Stage Builds — HIGH">
