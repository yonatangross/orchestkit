...
<ContextualSkillSidebar slug="design-system-tokens" />

> **Design System Tokens** Design token management with the W3C Design Token spec, three-tier hierarchy (global/alias/component), OKLCH color, Style Dictionary transforms, and dark mode theming. Use when creating token files, implementing theme systems, or building design-to-code pipelines.
