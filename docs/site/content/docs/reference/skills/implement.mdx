...
<Accordion title="Agent Teams Full Stack">
...
<Accordion title="Agent Teams Phases">
...
<Accordion title="Agent Teams Security Audit">
...
<Accordion title="Cc Enhancements">
...
<Accordion title="Micro Planning Guide">
...
<Accordion title="Scope Creep Detection">
...
<Accordion title="Team Worktree Setup">
...
<Accordion title="Worktree Workflow">
...
<Accordion title="Implementation Review">
