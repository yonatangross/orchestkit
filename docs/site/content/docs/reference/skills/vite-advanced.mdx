...
<Accordion title="Vite: Chunk Optimization — HIGH">
...
<Accordion title="Vite: Environment API — MEDIUM">
...
<Accordion title="Vite: Library Mode — HIGH">
...
<Accordion title="Vite: Plugin Hooks — MEDIUM">
...
<Accordion title="Environment Api">
...
<Accordion title="Plugin Development">
...
<Accordion title="Ssr Configuration">
