...
### Route-Based Code Splitting — HIGH
...
### Python Backend Profiling — MEDIUM
...
### React DevTools Profiler — MEDIUM
...
### TanStack Query Optimistic Updates — HIGH
...
### TanStack Query Prefetching — HIGH
...
### Manual Memoization Escape Hatches — HIGH
