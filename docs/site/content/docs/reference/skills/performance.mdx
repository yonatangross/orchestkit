...
<Accordion title="HTTP & Prompt Caching — HIGH">
...
<Accordion title="Redis & Backend Caching — HIGH">
...
<Accordion title="CLS Prevention — CRITICAL">
...
<Accordion title="INP Optimization — CRITICAL">
...
<Accordion title="LCP Optimization — CRITICAL">
...
<Accordion title="Modern Image Formats — HIGH">
...
<Accordion title="Next.js Image Component — HIGH">
...
<Accordion title="Responsive Images — HIGH">
...
<Accordion title="Model Quantization — MEDIUM">
...
<Accordion title="Speculative Decoding — MEDIUM">
...
<Accordion title="vLLM Deployment — MEDIUM">
...
<Accordion title="Lazy Component Loading — HIGH">
...
<Accordion title="Prefetch Strategies — HIGH">
...
<Accordion title="Route-Based Code Splitting — HIGH">
...
<Accordion title="Python Backend Profiling — MEDIUM">
...
<Accordion title="Bundle Analysis — MEDIUM">
...
<Accordion title="React DevTools Profiler — MEDIUM">
...
<Accordion title="TanStack Query Optimistic Updates — HIGH">
...
<Accordion title="TanStack Query Prefetching — HIGH">
...
<Accordion title="React Compiler — HIGH">
...
<Accordion title="Manual Memoization Escape Hatches — HIGH">
...
<Accordion title="List Virtualization — HIGH">
...
<Accordion title="Devtools Profiler Workflow">
...
<Accordion title="Memoization Escape Hatches">
...
<Accordion title="Quantization Guide">
...
<Accordion title="React Compiler Migration">
...
<Accordion title="Route Splitting">
...
<Accordion title="State Colocation">
...
<Accordion title="Tanstack Virtual Patterns">
...
<Accordion title="Vllm Deployment">
...
<Accordion title="Image Checklist">
...
<Accordion title="Inference Optimization">
...
<Accordion title="Performance Audit Checklist">
...
<Accordion title="Image Examples">
...
<Accordion title="Orchestkit Performance Wins">
