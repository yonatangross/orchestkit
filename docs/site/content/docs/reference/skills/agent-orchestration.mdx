...
### Frameworks: Comparison & Selection — HIGH
...
### Multi-Agent: Debate & Conflict Resolution — HIGH
...
### Multi-Agent: Supervisor Pattern — CRITICAL
...
### Multi-Agent: Result Synthesis — HIGH
...
### Scenario: Multi-Scenario Orchestrator — MEDIUM
...
### Scenario: Routing & Synchronization — MEDIUM
