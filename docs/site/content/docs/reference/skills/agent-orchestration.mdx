...
<Accordion title="Frameworks: Microsoft Agent Framework / AutoGen — HIGH">
...
<Accordion title="Frameworks: Comparison & Selection — HIGH">
...
<Accordion title="Frameworks: CrewAI — HIGH">
...
<Accordion title="Loops: Plan-and-Execute — HIGH">
...
<Accordion title="Loops: ReAct Pattern — HIGH">
...
<Accordion title="Multi-Agent: Debate & Conflict Resolution — HIGH">
...
<Accordion title="Multi-Agent: Supervisor Pattern — CRITICAL">
...
<Accordion title="Multi-Agent: Result Synthesis — HIGH">
...
<Accordion title="Scenario: Multi-Scenario Orchestrator — MEDIUM">
...
<Accordion title="Scenario: Routing & Synchronization — MEDIUM">
...
<Accordion title="Claude Code Instance Management">
...
<Accordion title="Coordination Patterns">
...
<Accordion title="Crewai Patterns">
...
<Accordion title="Framework Comparison">
...
<Accordion title="Langgraph Implementation">
...
<Accordion title="Microsoft Agent Framework">
...
<Accordion title="Skill Agnostic Template">
...
<Accordion title="State Machine Design">
...
<Accordion title="Orchestration Checklist">
