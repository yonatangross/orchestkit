...
This agent activates for: ROI, cost-benefit, risk assessment, investment justification, business case, budget, revenue impact, cost analysis, financial, payback period, NPV, IRR, TCO, revenue projection
...
- [business-case-analysis](/docs/reference/skills/business-case-analysis)
- [brainstorming](/docs/reference/skills/brainstorming)
