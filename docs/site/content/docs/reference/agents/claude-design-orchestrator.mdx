...
> **Claude Design Orchestrator** Parses claude.ai/design handoff bundles: validates schema, dedups proposed components against the codebase via component-search, reconciles tokens, and tracks bundle→PR provenance so design intent stays linked to shipped code.
...
- [design-import](/docs/reference/skills/design-import)
- [design-ship](/docs/reference/skills/design-ship)
