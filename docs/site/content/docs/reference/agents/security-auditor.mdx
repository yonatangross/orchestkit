...
- [defense-in-depth](/docs/reference/skills/defense-in-depth)
- [auth-patterns](/docs/reference/skills/auth-patterns)
- [input-validation](/docs/reference/skills/input-validation)
- [llm-safety-patterns](/docs/reference/skills/llm-safety-patterns)
- [mcp-security-hardening](/docs/reference/skills/mcp-security-hardening)
