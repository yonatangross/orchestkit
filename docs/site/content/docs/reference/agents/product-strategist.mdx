...
> **Product Strategist** Product strategist: value proposition validation, feature-business alignment, build/buy/partner decisions, go/no-go.
...
- [write-prd](/docs/reference/skills/write-prd)
- [prd-to-goal](/docs/reference/skills/prd-to-goal)
