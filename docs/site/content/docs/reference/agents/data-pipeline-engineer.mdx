...
- [embeddings](/docs/reference/skills/embeddings)
- [rag-retrieval](/docs/reference/skills/rag-retrieval)
- [hyde-retrieval](/docs/reference/skills/hyde-retrieval)
- [query-decomposition](/docs/reference/skills/query-decomposition)
- [reranking-patterns](/docs/reference/skills/reranking-patterns)
- [contextual-retrieval](/docs/reference/skills/contextual-retrieval)
- [agentic-rag-patterns](/docs/reference/skills/agentic-rag-patterns)
- [pgvector-search](/docs/reference/skills/pgvector-search)
- [golden-dataset-management](/docs/reference/skills/golden-dataset-management)
- [golden-dataset-curation](/docs/reference/skills/golden-dataset-curation)
- [golden-dataset-validation](/docs/reference/skills/golden-dataset-validation)
- [semantic-caching](/docs/reference/skills/semantic-caching)
- [caching-strategies](/docs/reference/skills/caching-strategies)
- [background-jobs](/docs/reference/skills/background-jobs)
- [browser-content-capture](/docs/reference/skills/browser-content-capture)
- [devops-deployment](/docs/reference/skills/devops-deployment)
- [mem0-memory](/docs/reference/skills/mem0-memory)
