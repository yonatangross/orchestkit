...
description: "json-render catalog design specialist. Designs Zod-typed component catalogs, selects optimal shadcn components, constrains props for AI safety, and optimizes specs for token efficiency"
---
