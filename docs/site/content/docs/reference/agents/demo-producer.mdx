...
This agent activates for: demo, video, marketing, showcase, terminal recording, VHS, remotion, tutorial, screencast
...
- [terminal-demo-generator](/docs/reference/skills/terminal-demo-generator)
- [manim-visualizer](/docs/reference/skills/manim-visualizer)
- [remotion-composer](/docs/reference/skills/remotion-composer)
