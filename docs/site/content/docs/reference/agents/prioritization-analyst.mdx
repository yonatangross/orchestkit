...
> Prioritization specialist who scores features using RICE/ICE/WSJF frameworks, analyzes opportunity costs, manages backlog ranking, and recommends what to build next based on value and effort

## Activation Keywords

This agent activates for: RICE, ICE, WSJF, prioritization, backlog, opportunity cost keywords.
...
- [prioritization-frameworks](/docs/reference/skills/prioritization-frameworks)
