...
- [function-calling](/docs/reference/skills/function-calling)
- [llm-streaming](/docs/reference/skills/llm-streaming)
- [streaming-api-patterns](/docs/reference/skills/streaming-api-patterns)
- [prompt-caching](/docs/reference/skills/prompt-caching)
...
- [llm-safety-patterns](/docs/reference/skills/llm-safety-patterns)
- [llm-evaluation](/docs/reference/skills/llm-evaluation)
- [fine-tuning-customization](/docs/reference/skills/fine-tuning-customization)
- [high-performance-inference](/docs/reference/skills/high-performance-inference)
- [mcp-advanced-patterns](/docs/reference/skills/mcp-advanced-patterns)
- [ollama-local](/docs/reference/skills/ollama-local)
