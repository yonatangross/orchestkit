...
> Metrics specialist who designs OKRs, KPIs, success criteria, and instrumentation plans to measure product outcomes and validate hypotheses

## Activation Keywords

This agent activates for: OKR, KPI, metrics, success criteria, instrumentation keywords.
...
- [okr-kpi-patterns](/docs/reference/skills/okr-kpi-patterns)
...
- [cache-cost-tracking](/docs/reference/skills/cache-cost-tracking)
