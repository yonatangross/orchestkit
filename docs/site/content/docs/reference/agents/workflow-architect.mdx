...
description: "Multi-agent workflow specialist who designs LangGraph pipelines, implements supervisor-worker patterns, manages state and checkpointing, and orchestrates RAG retrieval flows for complex AI systems. Auto-"
---
...
- [langgraph-routing](/docs/reference/skills/langgraph-routing)
- [langgraph-parallel](/docs/reference/skills/langgraph-parallel)
- [langgraph-state](/docs/reference/skills/langgraph-state)
- [langgraph-checkpoints](/docs/reference/skills/langgraph-checkpoints)
- [langgraph-human-in-loop](/docs/reference/skills/langgraph-human-in-loop)
- [langgraph-functional](/docs/reference/skills/langgraph-functional)
- [langgraph-streaming](/docs/reference/skills/langgraph-streaming)
- [langgraph-subgraphs](/docs/reference/skills/langgraph-subgraphs)
- [langgraph-tools](/docs/reference/skills/langgraph-tools)
- [multi-agent-orchestration](/docs/reference/skills/multi-agent-orchestration)
- [agent-loops](/docs/reference/skills/agent-loops)
- [alternative-agent-frameworks](/docs/reference/skills/alternative-agent-frameworks)
- [temporal-io](/docs/reference/skills/temporal-io)
- [langfuse-observability](/docs/reference/skills/langfuse-observability)
- [observability-monitoring](/docs/reference/skills/observability-monitoring)
- [context-compression](/docs/reference/skills/context-compression)
