...
description: "Stateful API emulation with Vercel emulate. Seeds GitHub/Vercel/Google/Slack/Apple/Entra/AWS/MongoDB API environments, configures webhooks and port isolation"
---

<span className="badge badge-gray">inherit</span>
 <span className="badge badge-gray">testing</span>

> Stateful API emulation with Vercel emulate. Seeds GitHub/Vercel/Google/Slack/Apple/Entra/AWS/MongoDB API environments, configures webhooks and port isolation

## Activation Keywords

This agent activates for: replacing flaky API mocks with stateful emulation.
