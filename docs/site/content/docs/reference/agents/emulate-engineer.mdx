...
> **Emulate Engineer** Stateful API emulation via Vercel emulate 0.4+. Seeds GitHub/Vercel/Google/Slack/Apple/Entra/AWS/MongoDB/Okta/Resend/Stripe, webhooks, port isolation, Next.js adapter. Use to replace flaky API mocks.
