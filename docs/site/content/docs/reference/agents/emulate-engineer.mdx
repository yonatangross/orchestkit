...
description: "Stateful API emulation with Vercel emulate (v0.4+). Seeds GitHub/Vercel/Google/Slack/Apple/Entra/AWS/MongoDB/Okta/Resend/Stripe API environments, configures webhooks, per-worker port isolation, and Next.js same-origin adapter"
---

<span className="badge badge-gray">inherit</span>
 <span className="badge badge-gray">testing</span>

> Stateful API emulation with Vercel emulate (v0.4+). Seeds GitHub/Vercel/Google/Slack/Apple/Entra/AWS/MongoDB/Okta/Resend/Stripe API environments, configures webhooks, per-worker port isolation, and Next.js same-origin adapter
