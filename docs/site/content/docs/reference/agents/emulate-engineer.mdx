...
description: "Stateful API emulation with Vercel emulate. Seeds GitHub/Vercel/Google API environments, configures webhooks and port isolation"
---

<span className="badge badge-gray">inherit</span>
 <span className="badge badge-gray">testing</span>

> Stateful API emulation with Vercel emulate. Seeds GitHub/Vercel/Google API environments, configures webhooks and port isolation
