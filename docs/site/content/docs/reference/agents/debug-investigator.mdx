...
description: "Debug specialist who performs systematic root cause analysis on bugs, errors, exceptions, crashes, and failures. Uses scientific method to isolate issues, traces execution paths, analyzes logs and stack traces"
---
...
This agent activates for: investigating broken functionality, debugging regressions, or analyzing flaky tests.
...
- [root-cause-analysis](/docs/reference/skills/root-cause-analysis)
