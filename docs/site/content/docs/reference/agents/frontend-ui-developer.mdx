...
description: "Frontend developer who builds React 19/TypeScript components with optimistic updates, concurrent features, Zod-validated APIs, exhaustive type safety, and modern 2026 patterns"
---

<span className="badge badge-gray">inherit</span>
 <span className="badge badge-gray">frontend</span>

> Frontend developer who builds React 19/TypeScript components with optimistic updates, concurrent features, Zod-validated APIs, exhaustive type safety, and modern 2026 patterns

## Activation Keywords

This agent activates for: React, TypeScript, component, UI, frontend, optimistic updates, Zod, concurrent, TSX, hook, TanStack, Suspense, skeleton, form, validation, mutation, lazy loading, view transitions, scroll animations, PWA, charts, dashboard
...
- [unit-testing](/docs/reference/skills/unit-testing)
- [e2e-testing](/docs/reference/skills/e2e-testing)
- [webapp-testing](/docs/reference/skills/webapp-testing)
- [i18n-date-patterns](/docs/reference/skills/i18n-date-patterns)
- [motion-animation-patterns](/docs/reference/skills/motion-animation-patterns)
- [a11y-testing](/docs/reference/skills/a11y-testing)
- [focus-management](/docs/reference/skills/focus-management)
- [render-optimization](/docs/reference/skills/render-optimization)
- [shadcn-patterns](/docs/reference/skills/shadcn-patterns)
- [radix-primitives](/docs/reference/skills/radix-primitives)
- [biome-linting](/docs/reference/skills/biome-linting)
- [vite-advanced](/docs/reference/skills/vite-advanced)
- [zustand-patterns](/docs/reference/skills/zustand-patterns)
- [tanstack-query-advanced](/docs/reference/skills/tanstack-query-advanced)
- [form-state-patterns](/docs/reference/skills/form-state-patterns)
- [core-web-vitals](/docs/reference/skills/core-web-vitals)
- [image-optimization](/docs/reference/skills/image-optimization)
- [react-aria-patterns](/docs/reference/skills/react-aria-patterns)
- [wcag-compliance](/docs/reference/skills/wcag-compliance)
- [lazy-loading-patterns](/docs/reference/skills/lazy-loading-patterns)
- [view-transitions](/docs/reference/skills/view-transitions)
- [scroll-driven-animations](/docs/reference/skills/scroll-driven-animations)
- [responsive-patterns](/docs/reference/skills/responsive-patterns)
- [pwa-patterns](/docs/reference/skills/pwa-patterns)
- [recharts-patterns](/docs/reference/skills/recharts-patterns)
- [dashboard-patterns](/docs/reference/skills/dashboard-patterns)
- [edge-computing-patterns](/docs/reference/skills/edge-computing-patterns)
- [streaming-api-patterns](/docs/reference/skills/streaming-api-patterns)
