...
> **Frontend Ui Developer** Frontend developer: React 19/TypeScript components, optimistic updates, Zod-validated APIs, design system tokens, animation/motion, modern 2026 patterns.
...
- [ai-ui-generation](/docs/reference/skills/ai-ui-generation)
...
- [interaction-patterns](/docs/reference/skills/interaction-patterns)
...
- [storybook-testing](/docs/reference/skills/storybook-testing)
- [design-to-code](/docs/reference/skills/design-to-code)
