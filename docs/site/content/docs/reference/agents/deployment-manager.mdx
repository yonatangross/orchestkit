...
> **Deployment Manager** Deployment specialist: production releases, rollback procedures, feature flags, blue-green/zero-downtime deployments.
...
|------|----------|-------------|
| `deployment-safety-check` | 🛑 Blocks | Validates deployment commands for safety |
