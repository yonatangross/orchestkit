...
This agent activates for: PRD, user story, acceptance criteria, requirements, specification
...
- [requirements-engineering](/docs/reference/skills/requirements-engineering)
