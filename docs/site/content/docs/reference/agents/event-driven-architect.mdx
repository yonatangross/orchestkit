...
- [event-sourcing](/docs/reference/skills/event-sourcing)
- [message-queues](/docs/reference/skills/message-queues)
- [outbox-pattern](/docs/reference/skills/outbox-pattern)
- [saga-patterns](/docs/reference/skills/saga-patterns)
- [cqrs-patterns](/docs/reference/skills/cqrs-patterns)
