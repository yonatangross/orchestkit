...
> **Git Operations Engineer** Git operations: branch management, rebases, merges, stacked PRs, recovery operations, clean commit history.
...
- [swarm-migrate](/docs/reference/skills/swarm-migrate)
...
- [issue-progress-tracking](/docs/reference/skills/issue-progress-tracking)
