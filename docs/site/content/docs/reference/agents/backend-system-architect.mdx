...
> Backend architect who designs REST/GraphQL APIs, database schemas, microservice boundaries, and distributed systems. Focuses on scalability, security, performance optimization, and clean architecture patterns

## Activation Keywords

This agent activates for: API design, database schema, microservice, backend architecture, REST, GraphQL, distributed systems, endpoint, route, model, migration, authentication, authorization, JWT, OAuth, rate limiting, middleware, service layer, repository pattern, dependency injection
...
- [api-design-framework](/docs/reference/skills/api-design-framework)
- [api-versioning](/docs/reference/skills/api-versioning)
- [database-schema-designer](/docs/reference/skills/database-schema-designer)
- [grpc-python](/docs/reference/skills/grpc-python)
- [strawberry-graphql](/docs/reference/skills/strawberry-graphql)
- [error-handling-rfc9457](/docs/reference/skills/error-handling-rfc9457)
- [rate-limiting](/docs/reference/skills/rate-limiting)
- [architecture-decision-record](/docs/reference/skills/architecture-decision-record)
- [backend-architecture-enforcer](/docs/reference/skills/backend-architecture-enforcer)
- [owasp-top-10](/docs/reference/skills/owasp-top-10)
- [streaming-api-patterns](/docs/reference/skills/streaming-api-patterns)
- [observability-monitoring](/docs/reference/skills/observability-monitoring)
- [performance-optimization](/docs/reference/skills/performance-optimization)
- [devops-deployment](/docs/reference/skills/devops-deployment)
- [golden-dataset-management](/docs/reference/skills/golden-dataset-management)
...
- [resilience-patterns](/docs/reference/skills/resilience-patterns)
- [langgraph-supervisor](/docs/reference/skills/langgraph-supervisor)
- [mcp-server-building](/docs/reference/skills/mcp-server-building)
- [caching-strategies](/docs/reference/skills/caching-strategies)
- [auth-patterns](/docs/reference/skills/auth-patterns)
- [asyncio-advanced](/docs/reference/skills/asyncio-advanced)
- [sqlalchemy-2-async](/docs/reference/skills/sqlalchemy-2-async)
- [fastapi-advanced](/docs/reference/skills/fastapi-advanced)
- [connection-pooling](/docs/reference/skills/connection-pooling)
- [idempotency-patterns](/docs/reference/skills/idempotency-patterns)
- [domain-driven-design](/docs/reference/skills/domain-driven-design)
- [aggregate-patterns](/docs/reference/skills/aggregate-patterns)
- [distributed-locks](/docs/reference/skills/distributed-locks)
