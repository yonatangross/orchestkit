...
> **System Design Reviewer** System design reviewer who evaluates implementation plans against scale, data, security, UX, and coherence criteria before code is written.
...
- [visualize-plan](/docs/reference/skills/visualize-plan)
