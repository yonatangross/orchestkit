...
<span className="badge badge-green">haiku</span>
 <span className="badge badge-gray">docs</span>

> Technical writing and documentation expert. API docs, READMEs, technical guides, ADRs, changelogs, and OpenAPI specs
