...
description: "38 specialized agents -- how they activate, what they know, and when to use each."
full: true
---

import { LazyAgentSelector as AgentSelector } from '@/components/lazy';

# 38 Specialists, One Prompt Away
