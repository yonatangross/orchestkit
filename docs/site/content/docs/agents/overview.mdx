...
# 37 Specialists, One Prompt Away
...
- **`sonnet`** -- Used for focused production tasks (debug, db, llm, perf, video, web research). 11 agents use Sonnet.
