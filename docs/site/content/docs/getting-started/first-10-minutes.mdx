...
This runs diagnostics on all 79 skills, 30 agents, and 105 hooks. If anything is misconfigured, it tells you exactly what to fix.
...
| `test-generator` | Writes tests alongside code | testing-patterns |
