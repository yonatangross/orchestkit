...
Tavily requires a free API key ([app.tavily.com](https://app.tavily.com) — 1,000 credits/month free).
...
- Without `tavily`: web research falls back to `WebFetch` → `agent-browser`
...
```
ork v7.0.0 │ feat/my-branch │ 3 uncommitted
```
