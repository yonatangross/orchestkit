...
- Compatible with Claude Code >= 2.1.75
...
```bash
claude plugin marketplace add yonatangross/orchestkit@beta
```
</Step>
<Step>
### Install from beta
...
```bash
claude plugin marketplace add yonatangross/orchestkit@alpha
```
</Step>
<Step>
### Install from alpha
...
```bash
claude plugin marketplace remove orchestkit
claude plugin marketplace add yonatangross/orchestkit@beta
