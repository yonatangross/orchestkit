...
<Cards>
  ...
  <Card title="Claude Design → PR" href="/docs/cookbook/claude-design-handoff" description="Turn a claude.ai/design handoff bundle into a reviewable PR with one command" />
  <Card title="Review a Pull Request" href="/docs/cookbook/review-pr" description="Multi-agent code review with security, performance, and style checks" />
  ...
  <Card title="Task Management Patterns" href="/docs/cookbook/task-management" description="Track complex work with TaskCreate, TaskUpdate, and dependency chains" />
  <Card title="Set Up Cross-Session Memory" href="/docs/cookbook/setup-memory" description="Configure the 3-tier memory system for persistent context" />
  ...
  <Card title="Run a Security Audit" href="/docs/cookbook/security-audit" description="Run OWASP Top 10 checks and defense-in-depth verification" />
</Cards>
