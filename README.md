...
**<!--ork:skills-->106<!--/ork--> skills · <!--ork:agents-->36<!--/ork--> agents · <!--ork:hooks-->176<!--/ork--> hooks**
...
| **<!--ork:hooks-->176<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
...
**Scope: broad and intentional.** OrchestKit registers <!--ork:hooks-->176<!--/ork--> hooks across <!--ork:events-->32<!--/ork-->
