...
[![Claude Code](https://img.shields.io/badge/Claude_Code-≥2.1.72-7C3AED?style=for-the-badge&logo=anthropic)](https://claude.ai/claude-code)
...
Requires **≥2.1.72**. Check with `claude --version`.
</details>
