...
**<!--ork:skills-->106<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->182<!--/ork--> hooks**
...
| **<!--ork:hooks-->182<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
