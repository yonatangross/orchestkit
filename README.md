...
**<!--ork:skills-->111<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->208<!--/ork--> hooks**
...
| **<!--ork:hooks-->208<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
