...
**<!--ork:skills-->109<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->195<!--/ork--> hooks**
...
| **<!--ork:hooks-->195<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
