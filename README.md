...
**<!--ork:skills-->91<!--/ork--> skills · <!--ork:agents-->31<!--/ork--> agents · <!--ork:hooks-->97<!--/ork--> hooks**
...
| Component | Details |
|-----------|---------|
| **<!--ork:skills-->91<!--/ork--> Skills** | RAG patterns, FastAPI, React 19, testing, security, database design, ML integration — loaded on-demand, zero overhead |
...
| **<!--ork:hooks-->97<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
