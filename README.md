...
**<!--ork:skills-->105<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->184<!--/ork--> hooks**
...
| **<!--ork:hooks-->184<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
