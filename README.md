...
**<!--ork:skills-->105<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->181<!--/ork--> hooks**
...
| **<!--ork:hooks-->181<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
