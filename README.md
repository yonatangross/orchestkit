...
**<!--ork:skills-->109<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->194<!--/ork--> hooks**
...
| **<!--ork:hooks-->194<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
