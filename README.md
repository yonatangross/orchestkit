...
[![Claude Code](https://img.shields.io/badge/Claude_Code-≥2.1.73-7C3AED?style=for-the-badge&logo=anthropic)](https://claude.ai/claude-code)
...
Requires **≥2.1.73**. Check with `claude --version`.
</details>
