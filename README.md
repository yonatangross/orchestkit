...
**<!--ork:skills-->114<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->215<!--/ork--> hooks**
...
| **<!--ork:hooks-->215<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
...
Requires **≥2.1.183** (supported floor; Opus 4.8, `xhigh` effort, dynamic workflows, `sandbox.network.deniedDomains`, native binary, hardened `Bash(rm:*)`/`Bash(find:*)` rules). Check with `claude --version`.
</details>
