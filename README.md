...
**<!--ork:skills-->101<!--/ork--> skills · <!--ork:agents-->36<!--/ork--> agents · <!--ork:hooks-->111<!--/ork--> hooks**
...
| Component | Details |
|-----------|---------|
| **<!--ork:skills-->101<!--/ork--> Skills** | RAG patterns, FastAPI, React 19, testing, security, database design, ML integration — loaded on-demand, zero overhead |
...
| **<!--ork:hooks-->111<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
