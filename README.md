...
**<!--ork:skills-->112<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->199<!--/ork--> hooks**
...
| **<!--ork:hooks-->199<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
