...
**<!--ork:skills-->107<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->185<!--/ork--> hooks**
...
| **<!--ork:hooks-->185<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
