...
**<!--ork:skills-->93<!--/ork--> skills · <!--ork:agents-->33<!--/ork--> agents · <!--ork:hooks-->106<!--/ork--> hooks**
...
| Component | Details |
|-----------|---------|
| **<!--ork:skills-->93<!--/ork--> Skills** | RAG patterns, FastAPI, React 19, testing, security, database design, ML integration — loaded on-demand, zero overhead |
...
| **<!--ork:hooks-->106<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
