...
**<!--ork:skills-->108<!--/ork--> skills · <!--ork:agents-->37<!--/ork--> agents · <!--ork:hooks-->191<!--/ork--> hooks**
...
| **<!--ork:hooks-->191<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
