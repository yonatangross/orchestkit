...
**<!--ork:skills-->81<!--/ork--> skills · <!--ork:agents-->30<!--/ork--> agents · <!--ork:hooks-->107<!--/ork--> hooks**
...
| Component | Details |
|-----------|---------|
| **<!--ork:skills-->81<!--/ork--> Skills** | RAG patterns, FastAPI, React 19, testing, security, database design, ML integration — loaded on-demand, zero overhead |
...
| **<!--ork:hooks-->107<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
