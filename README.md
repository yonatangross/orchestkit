...
**<!--ork:skills-->103<!--/ork--> skills · <!--ork:agents-->36<!--/ork--> agents · <!--ork:hooks-->162<!--/ork--> hooks**
...
| **<!--ork:hooks-->162<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
...
- **103 skills**, **36 agents**, **162 hooks**, **23 invocable commands**
