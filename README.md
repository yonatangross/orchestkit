...
**<!--ork:skills-->89<!--/ork--> skills · <!--ork:agents-->31<!--/ork--> agents · <!--ork:hooks-->101<!--/ork--> hooks**
...
- **Simplified**: One plugin for everything. All 80 skills, 30 agents, 107 hooks in `/plugin install ork`.
