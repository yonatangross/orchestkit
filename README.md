...
**<!--ork:skills-->81<!--/ork--> skills · <!--ork:agents-->30<!--/ork--> agents · <!--ork:hooks-->95<!--/ork--> hooks**
...
| **<!--ork:hooks-->95<!--/ork--> Hooks** | Pre-commit checks, git protection, quality gates, browser safety — ship with confidence |
